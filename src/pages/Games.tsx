...
const secondary = '#f07d13' // orange (kept for consistency, even if not used directly here)
                ...
                {filtered.map((p, i) => {
                    ...
                    return (
                        <Grid key={p.title + i} item xs={12} sm={6} md={4}>
                            <Box>
                                {/* Square image tile with hover overlay (same pattern as Projects) */}
                                <Box
                                    sx={{
                                        position: 'relative',
                                        borderRadius: 3,
                                ...
                                >
                                    {/* 1:1 aspect ratio for square tiles */}
